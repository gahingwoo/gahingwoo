...
- Developed an OP-TEE BL32 platform port for RK3576; it passed automated checks, was reproduced on real hardware, and is approved pending merge.
...
References: [OP-TEE PR #7821](https://github.com/OP-TEE/optee_os/pull/7821) · [TF-A Gerrit #51089](https://review.trustedfirmware.org/c/TF-A/trusted-firmware-a/+/51089) · [Project pages](https://gahingwoo.github.io/)
